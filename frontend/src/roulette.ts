...
export class Roulette extends EventTarget {
  ...
  private _stateBuffer: { timestamp: number; gameState: gamestate.IGameStateDto }[] = [];
  ...
  private _interpolateState(
    fromState: gamestate.IGameStateDto,
    toState: gamestate.IGameStateDto,
    alpha: number,
  ): void {
